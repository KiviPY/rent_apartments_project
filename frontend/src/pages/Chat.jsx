...
export default function Chat() {
    ...
    return (<div style={{
        ...
        <span onClick={() => navigate(-1)} style={{
            ...
            {/* Сообщения */}
            <div style={{
                flex: 1, overflowY: "auto", padding: "20px 24px", display: "flex", flexDirection: "column", gap: 10
            }}>
                {loading && <p className="loading-msg">Загрузка...</p>}

                {messages.map((msg, i) => {
                    const isMine = msg.sender === account?.id || msg.sender_username === account?.username
                    return (<div key={msg.id ?? i} style={{
                            display: "flex",
                            ...
                            <div style={{
                                ...
                                background: isMine ? "linear-gradient(135deg, #7c6ef7, #a78bfa)" : "var(--bg2)",
                                border: isMine ? "none" : "1px solid var(--glass-border)",
                                color: "#fff",
                                boxShadow: isMine ? "0 4px 16px rgba(124,110,247,0.3)" : "0 2px 8px rgba(0,0,0,0.2)",
                            }}>
                                {!isMine && (<div style={{
                                        fontSize: 11,
                                        fontWeight: 700,
