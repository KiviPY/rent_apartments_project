...
export default function EditApartment() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const textFields = [
                ...
                "max_residents", "bedrooms", "bathrooms", "size_of_property", "status"
            ]
    ...
    const section = (title) => (
        <h3 style={{
            marginTop: 24, marginBottom: 12, color: "var(--text)",
            borderBottom: "1px solid var(--glass-border)", paddingBottom: 6
        }}>
            {title}
        </h3>
    )
                    ...
                    <label className="auth-field">
                        ...
                        <textarea value={form.description} onChange={setE("description")} rows={4}
                                  style={{
                                      ...
                                      border: "1px solid var(--glass-border)", fontSize: 15, resize: "vertical",
