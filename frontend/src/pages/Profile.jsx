            ...
            <div className="container" style={{maxWidth: 860}}>
                ...
                <div style={{
                    ...
                    <button className="btn" onClick={logout}
                            style={{
                                marginLeft: "auto", background: "var(--glass)",
                            ...
                            <>
                                {[
                                    ...
                                    <div key={key} style={{
                                        ...
                                        <span
                                            style={{fontWeight: 600, color: "var(--text)"}}>{account[key] || "—"}</span>
                                    </div>
                                ))}
                                <div style={{
                                    display: "flex", justifyContent: "space-between",
                            ...
                            {apartments.map(ap => (
                                <div key={ap.id} style={{
                                    ...
                                    {ap.images?.[0]
                                        ...
                                        : <div style={{
                                            width: 130, height: 100, background: "var(--bg3)",
                                            display: "flex", alignItems: "center", justifyContent: "center",
                                    ...
                                    <div style={{
                                        ...
                                        <button className="btn" onClick={() => navigate(`/apartments/${ap.id}`)}
                                                style={{fontSize: 12, padding: "5px 12px"}}>Открыть
                                        </button>
                        ...
                        {chats.map(room => (
                            <div key={room.id} onClick={() => navigate(`/chat/${room.id}`)}
                                ...
                                <div style={{flex: 1, minWidth: 0}}>
                                    ...
                                    {room.last_message && (
                                        <p style={{
                                            margin: "4px 0 0", fontSize: 14, color: "var(--text2)",
